...
const UPDATE_STANZA = 'UPDATE_STANZA';
...
const CityOfBrahman = {title: `The City of Brahman`,
	text: `In the city of Brahman is a secret dwelling, the lotus of the heart. 
	...
	This knows no age when the body ages; 
	this knows no dying when the body dies. 
	This is the real city of Brahman; 
	this is the Self, free from old age, 
	from death and grief, hunger and thirst. 
	In the Self all desires are fulfilled.

	The Self desires only what is real, 
	thinks nothing but what is true. 
	Here people do what they are told, 
	becoming dependent on their country, 
	or their piece of land, 
	or the desires of another, 
	so their desires are not fulfilled 
	and their works come to nothing, 
	both in this world and in the next. 

	Those who depart from this world without knowing who they are 
	or what they truly desire 
	have no freedom here or hereafter.

	But those who leave here knowing 
	who they are and what they truly desire 
	have freedom everywhere, 
	both in this world and in the next.

	Like strangers in an unfamiliar country 
	walking over a hidden treasure, 
	day by day we enter the world of Brahman 
	while in deep sleep but never find it, 
	...
	Immortal, free from fear, 
	this Self is Brahman, called the True. 
	Beyond the mortal and the immortal, 
	he binds both worlds together. 
	Those who know this live day after day 
	...
	nor old age, nor death, nor grief, 
	nor evil or good deeds. 
	All evils turn back there, 
	unable to cross; 
	evil comes not into this world of Brahman.

	One who crosses by this bridge, therefore, 
	if blind, is blind no more; 
	if hurt, ceases to be hurt; 
	if in sorrow, ceases sorrowing. 
	At this boundary night itself becomes day: 
    night comes not into this world of Brahman.

	Only those who are pure and self-controlled 
	can find this world of Brahman. 
	That world is theirs alone. 
	In that world, in all the worlds, 
